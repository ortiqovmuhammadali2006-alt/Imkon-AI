...
const ROLE_THEME: Record<Role, RoleTheme> = {
  admin: {
    ...
    header: "bg-surface/85 border-slate-200/70",
  ...
  teacher: {
    page: "bg-surface",
    sidebar: "border-r border-slate-200/70 bg-surface",
    logoLight: false,
    ...
    userCard: "bg-slate-50 ring-slate-100 hover:bg-indigo-50",
  ...
  student: {
    ...
    sidebar: "border-r border-indigo-100 bg-gradient-to-b from-indigo-50 to-surface",
    logoLight: false,
    ...
    userCard: "bg-surface shadow-sm ring-indigo-100 hover:bg-indigo-50",
    userName: "text-slate-900",
    userRole: "text-indigo-700",
    header: "bg-surface/85 border-indigo-100",
    loader: "text-indigo-600",
    logoutHover: "text-slate-500 hover:bg-red-50 hover:text-red-600",
